...
private VersionDao   versionDao;
   ...
   { 
    	//System.out.print("List all top-level files and folders"+"\n");
...
// For React SPA , its returns a JSON item 
@GetMapping("getElem/{id}")
@ResponseStatus(HttpStatus.ACCEPTED)
public  FolderDto getParentId( @PathVariable Integer id )
{   
    //Intiaite an arrayList of Dtos
      List<FolderDto> folderDtos= new ArrayList<FolderDto>();
    
        //get Folders where id={id} form URL
        Folder  folderObj = folderDao.getFolder( id );

        return new FolderDto(folderObj);
